...
public class IsJsonTest : IClassFixture<TestDatabaseFixture>
{
    ...
    public void IsJson_SelectFirstOrDefaultStringNameColumn_ShouldReturnZero()
    {
        ...
        var result = _context.Countries.Select(s => EF.Functions.IsJson(s.Name)).FirstOrDefault();
    ...
    {
        using var _context = Fixture.CreateContext();
        var result = _context.Countries.Select(s => EF.Functions.IsJson(s.CountryDetail)).FirstOrDefault();
    ...
    {
        using var _context = Fixture.CreateContext();
        var result = _context.Countries.Select(s => EF.Functions.IsJson(s.ExtraInformation)).FirstOrDefault();
    ...
    {
        using var _context = Fixture.CreateContext();
        var result = _context.Countries.Select(s => EF.Functions.IsJson(s.UtcTimeZones)).FirstOrDefault();
    ...
    {
        using var _context = Fixture.CreateContext();
        var result = _context.Countries.Select(s => EF.Functions.IsJson(s.OfficialLanguages)).FirstOrDefault();
    ...
    {
        using var _context = Fixture.CreateContext();
        var result = _context.Countries.Where(s => EF.Functions.IsJson(s.Name) == 1).ToList();
    ...
    {
        using var _context = Fixture.CreateContext();
        var result = _context.Countries.Where(s => EF.Functions.IsJson(s.Name) == 0).ToList();
    ...
    {
        using var _context = Fixture.CreateContext();
        var result = _context.Countries.Where(s => EF.Functions.IsJson(s.ExtraInformation) == 1).ToList();
    ...
    {
        using var _context = Fixture.CreateContext();
        var result = _context.Countries.Where(s => EF.Functions.IsJson(s.ExtraInformation) == 0).ToList();
    ...
    {
        using var _context = Fixture.CreateContext();
        var result = _context.Countries.Where(s => EF.Functions.IsJson(s.OfficialLanguages) == 1).ToList();
    ...
    {
        using var _context = Fixture.CreateContext();
        var result = _context.Countries.Where(s => EF.Functions.IsJson(s.OfficialLanguages) == null).ToList();
